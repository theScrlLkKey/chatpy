...
while True:
    try:
        ...
        while True:
            ...
            # Print message
            if message == '/post':
                smessage = f'!msg {username} Hi! I control the forum here. Run "/post new <post> ;;; <title>" to post a new submission, "/post list" for all posts (sorted by new), "/post read <post ID>"'
